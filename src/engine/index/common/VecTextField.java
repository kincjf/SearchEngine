...
/**
 * own field for create term vectors(content)
 * @author KIMSEONHO
 *
 */
public class VecTextField extends Field {
	...
	public VecTextField(String name, Reader reader, Field.Store store) {
		super(name, reader, store == Field.Store.YES ? TYPE_STORED : TYPE_NOT_STORED);
	}

	/** Creates a new TextField with String value. */
	public VecTextField(String name, String value, Field.Store store) {
